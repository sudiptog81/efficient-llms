...
const NewsletterSubscribe = () => {
  ...
  return (
    <section id="subscribe" className="max-w-7xl mx-auto pt-20 border-t border-zinc-200 dark:border-gray-800">
      <form className="max-w-4xl mx-auto rounded-2xl text-white text-center">
        <div className="max-w-4xl flex flex-col md:flex-row justify-center items-center mx-auto gap-4 gap-x-2">
          <input
            type="email"
            placeholder="Enter your e-mail"
            className="px-4 py-3 w-full md:w-6xl text-center rounded-full border-2 border-zinc-300 dark:border-white md:mr-4 font-bold placeholder-gray-800 dark:placeholder-white focus:placeholder-transparent"
            required
            value={email}
