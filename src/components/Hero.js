  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 pt-12 lg:py-32 text-center">
      <div className="space-y-6">
        <p className="text-sm font-semibold tracking-wider uppercase text-indigo-800 dark:text-indigo-400 md:mb-2">
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tighter max-w-4xl mx-auto leading-tight">
          Scaling <span className="text-indigo-800 dark:text-indigo-400">Intelligence</span>, Cutting <span className="text-red-600 dark:text-red-400">Cost</span>.
        </h1>
