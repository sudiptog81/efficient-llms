...
const Join = () => (
  <section id="join" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div className="max-w-4xl mx-auto p-10 lg:p-15 bg-indigo-800 dark:bg-indigo-500 rounded-2xl text-white text-center shadow-2xl">
